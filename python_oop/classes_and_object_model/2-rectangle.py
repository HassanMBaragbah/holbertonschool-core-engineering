...
getters/setters, validation, and methods to calculate area and perimeter.
"""
...
class Rectangle:
    ...
    def area(self):
        """Calculate and return the current area of the rectangle.
    ...
    def perimeter(self):
        """Calculate and return the current perimeter of the rectangle.
